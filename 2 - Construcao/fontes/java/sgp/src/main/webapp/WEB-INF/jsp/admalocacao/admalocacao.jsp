...
<head>
	...
	<script src="<%=request.getContextPath()%>/js/admalocacao.js"></script>
                ...
                <div class="row">
					...
					<div class="panel panel-default">
						...
						<br>
							...
							<div class="col-lg-6">
							<div id="criarAlocacao" class="form-group">
								<label>Projeto:</label>
								<select id="nomeProjeto" class="form-control">
                                ...
                                <br>
                                <label>Recurso:</label>
                                <select id="nomeRecurso" class="form-control">
                                    <c:forEach items="${listaRecursos}" var="recurso">
                                    	<option value="${recurso.idRecurso}">${recurso.nmRecurso}</option>
									</c:forEach>
                                </select>	
                                <br>
                                <label>Data Inicio:</label>
                                <input id="dataInicio" class="form-control">
                                
                                <label>Data Fim:</label>
                                <input id="dataFim" class="form-control">
                            
                            <br>
                            <br>
							<button id="bottonBusca" type="button" class="btn btn-primary" onclick="criarAlocacao()">Criar</button>							
                        </div>						
                    </div>
                </div>
             <br><br>
